...
LearningJourney_SelectedCourse = db.Table("learningjourney_selectedcourse",
                        db.Column('Journey_ID', db.String(16), db.ForeignKey("learningjourney.Journey_ID")),
                        db.Column('Course_ID', db.String(16), db.ForeignKey(Course.Course_ID)),
)
...
class LearningJourney(db.Model):
    ...
    Staff_ID = db.Column(db.Integer, db.ForeignKey(Staff.Staff_ID), nullable=False)
    LearningJourney_Status = db.Column(db.String(15))
